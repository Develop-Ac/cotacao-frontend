...
export default function AuditoriaPage() {
    ...
    const handleSave = async (item: AuditoriaItem) => {
        ...
        try {
            ...
            setAllItems(prev => prev.map(i => i.cod_produto === item.cod_produto ? { ...i, ja_auditado: true } : i));
        } catch (e: any) {
        ...
        <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            <div className="flex flex-col gap-4">
                {itens.filter(i => !hideAudited || !i.ja_auditado).map((item) => (
                    <div key={item.cod_produto} className={`bg-white dark:bg-boxdark rounded-lg shadow border-l-4 ${item.ja_auditado ? 'border-green-500' : 'border-red-500'} p-4`}>
                            ...
                            <div className="flex-1 min-w-[300px] flex flex-col gap-2">
                                ...
                                {!item.ja_auditado ? (
                                    ...
                                    <div className="bg-green-50 border border-green-200 p-3 rounded text-center">
                                        <div className="text-green-800 font-bold mb-1 flex items-center justify-center gap-2">
                                            <FaCheck className="text-green-600" /> Auditoria Concluída
                                        </div>
